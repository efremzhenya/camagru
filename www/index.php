...
<body>
  ...
  <div class="container">
    ...
    <div class="row align-items-center my-5">
      ...
      <!-- /.col-lg-8 -->
      <div class="col-lg-5">
        <h1 class="font-weight-light">About CAMAGRU</h1>
        <p>This is a simple webcam snap service. Let's try use it!</p>
        <a class="btn btn-primary" href="#">Snap me!</a>
      </div>
      <!-- /.col-md-4 -->
    </div>
    <!-- /.row -->
    ...
    <div class="card text-white bg-secondary my-5 py-4 text-center">
      <div class="card-body">
        <p class="text-white m-0">Last snaps circle block!</p>
      </div>
    </div>
